...
def delete_context_tables(context_id: str):
    ...
    # its still-live participants_context_/variables_context_ cache entries would be
    # silently served to that unrelated future context until their timeout elapses.
    cache.delete_many([f'participants_context_{context_id}', f'variables_context_{context_id}'])
